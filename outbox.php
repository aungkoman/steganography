...
<html lang="en">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="outbox.php">ထြက္စာမ်ား</a></li>
  ...
  <?php
    ...
    $sql="SELECT * FROM telegraphs WHERE sender ='$sender'";
          ...
          if ($result->num_rows >0){
            ...
            echo "<tr>".$_SESSION['unit_id']." ထြက္စာမ်ား မရိွေသးပါ</tr>";
          }
