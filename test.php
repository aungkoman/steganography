...
echo "<br>changes are => ".json_encode($pwa_columnar->index_changes($user_key,$sorted_str));
echo "<br>changes are => ".json_encode($pwa_columnar->index_changes($sorted_str,$user_key));
...
$transposited_array = $pwa_columnar->transposition($new_array,$user_key);

$retransposited_array = $pwa_columnar->re_transposition($transposited_array,$user_key);

echo "retransposited_array have to be new array <br>";
echo "shall we <br>";
echo json_encode($retransposited_array);
